Music Zone- CD store web site (2013)

Locations:
-CSI5380.PART1.VAHAM.zip contains following folders/files:
|---SourceCode
    |--MusicZoneBackend
       |-- src
       |-- WebContent  
    ...
    |--Music_Zone_View_Controller
       ...
       |-- WebContent
|---Test
    |--Readme(testingWebService).txt
    |--TestCase.pdf
    |--TestScripts4WebService.zip
|---DesignDocument.pdf
|---Readme.txt
|---References.txt

1.    Source code folder which includes two projects: MusicZoneBackend and  Music_Zone_View_Controller.
2.    Test cases folder which includes screenshots and scripts of our webservices testing.
3.    Design document
...
1    Frontend: web contents/jsps                BY: Amanpreet    
2    Frontend controller/servlets               BY: Vahid / Ameya    
3    Backend webservice: order processing       BY: Ameya    
4    Backend webservice: product catalog        BY: Mandy    
5    Backend dbagent                            BY: Haifa    
6    Logging(log4j)                             BY: Mandy    
7    Testing                                    BY: ALL 
8    Documentation                              BY: All    
9    Integration                                BY: ALL
----------------------------------------------------------------------------------------------------------------------------------------------
